...
describe('#cancelLoanOffering', () => {
  ...
  contract('Margin', function(accounts) {
    ...
    it('cancels an amount of a loan offering', async () => {
      ...
      const tx = await callCancelLoanOffer(margin, loanOffering, cancelAmount);
    ...
    it('increments canceled amount if already partially canceled', async () => {
      ...
      await callCancelLoanOffer(margin, loanOffering, cancelAmount);

      await callCancelLoanOffer(margin, loanOffering, cancelAmount2);
    });
