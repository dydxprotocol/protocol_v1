...
contract ShortSellRepo is AccessControlled {
  ...
  function containsShort(bytes32 id)
    constant
    public
    returns (bool exists) {
  ...
  function deleteShort(bytes32 id) requiresAuthorization {
    delete shorts[id];
  }
}
