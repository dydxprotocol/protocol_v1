...
library LoanImpl {
        ...
        returns (bool)
    {
        ...
        address newContractAddr = MarginCallDelegator(contractAddr).marginCallOnBehalfOf(
            msg.sender,
            positionId,
            requiredDeposit
        );
        ...
        returns (bool)
    {
        ...
        address newContractAddr = MarginCallDelegator(contractAddr).cancelMarginCallOnBehalfOf(
            msg.sender,
            positionId
        );
